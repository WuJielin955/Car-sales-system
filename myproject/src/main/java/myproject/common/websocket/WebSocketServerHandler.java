...
import myproject.constants.WSErrorCode;
import myproject.constants.WSType;
import myproject.service.ChatService;
...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<WebSocketFrame> {
	...
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		...
		Constants.webSocketHandshakerMap.remove(ctx.channel());
	...
	private void sendErrorMessage(ChannelHandlerContext ctx, Integer errorStatus, String errorMsg) {
		String responseJson = Result.error(errorStatus, errorMsg).toString();
